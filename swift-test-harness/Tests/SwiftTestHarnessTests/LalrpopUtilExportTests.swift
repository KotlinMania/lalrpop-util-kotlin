...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `LalrpopUtil.swiftmodule/`
...
//      `import LalrpopUtil` above would fail at compile time.
//
//   2. The static archive `libLalrpopUtil.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "LalrpopUtil" }` and
//      `flattenPackage = "io.github.kotlinmania.lalrpoputil"` configuration in
...
//      via the `LalrpopUtilLibrary` product.
//
