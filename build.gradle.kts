...
kotlin {
    ...
    macosArm64 {
        binaries.framework { baseName = "LalrpopUtil"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "LalrpopUtil"; xcf.add(this) }
    }
...
mavenPublishing {
    ...
    pom {
        ...
        description.set("Kotlin Multiplatform port of the lalrpop-util crate. Runtime support for parsers generated by lalrpop-kotlin.")
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/lalrpoputil/codeql/_CodeqlEmptySource.kt")
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.lalrpoputil.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleLalrpopUtilXCFramework",
)
